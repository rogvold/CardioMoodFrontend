CardioSessionManager = function(){
    ...
    this.loadTensionPoints = function(intervals, callback){
        $.ajax({
    ...
    this.loadSigmaPoints = function(intervals, callback){
        $.ajax({
    ...
    this.initUpdatingInterval = function(){
        setInterval(function(){
            ...
            if ($('.sessionsListItem.active').hasClass('freshSession') == false){
